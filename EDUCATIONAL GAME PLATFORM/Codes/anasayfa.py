def run():
    ...
    while cap.isOpened():
        ...
        h, w, _ = frame.shape
        # Draw the buttons
        cv2.rectangle(frame, (margin, margin), (margin + button_size, margin + button_size), (255, 0, 0), 2)  # Sol üst
        cv2.rectangle(frame, (w - margin - button_size, margin), (w - margin, margin + button_size), (255, 0, 0), 2)  # Sağ üst
        cv2.rectangle(frame, (margin, h - margin - button_size), (margin + button_size, h - margin), (255, 0, 0), 2)  # Sol alt
        cv2.rectangle(frame, (w - margin - button_size, h - margin - button_size), (w - margin, h - margin), (255, 0, 0), 2)  # Sağ alt
