def run():
    ...
    def random_image(true_num, false_num):
        images = {0: "kahverengi.png", 1: "kirmizi.png", 2: "mavi.png", 3: "mor.png", 4: "pembe.png", 5: "sari.png", 6: "turuncu.png", 7:"yesil.png" }
        true_num = random.randint(0, 7)
        false_num = random.randint(0, 7)
    ...
    def log_game_duration(duration):
        with open('renkler_dosyalar/renk_secimi_log.csv', mode='a', newline='') as file:
            writer = csv.writer(file)
            writer.writerow([datetime.now().strftime('%Y-%m-%d %H:%M:%S'), duration])

    images = {0: "kahverengi.png", 1: "kirmizi.png", 2: "mavi.png", 3: "mor.png", 4: "pembe.png", 5: "sari.png", 6: "turuncu.png", 7:"yesil.png"}
    sounds = {0: "kahverengi.wav", 1: "kirmizi.wav", 2: "mavi.wav", 3: "mor.wav", 4: "pembe.wav", 5: "sari.wav", 6: "turuncu.wav", 7:"yesil.wav"}
    ...
    pygame.init()
    pygame.mixer.music.load("renkler_dosyalar/sounds/ingilizce/kadin/yanlis.wav")
    pygame.mixer.music.load('renkler_dosyalar/sounds/ingilizce/kadin/dogru.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/ingilizce/kadin/kahverengi.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/ingilizce/kadin/kirmizi.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/ingilizce/kadin/mavi.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/ingilizce/kadin/mor.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/ingilizce/kadin/pembe.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/ingilizce/kadin/sari.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/ingilizce/kadin/turuncu.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/ingilizce/kadin/yesil.wav')

    pygame.mixer.music.load('renkler_dosyalar/sounds/ingilizce/erkek/yanlis.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/ingilizce/erkek/dogru.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/ingilizce/erkek/kahverengi.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/ingilizce/erkek/kirmizi.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/ingilizce/erkek/mavi.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/ingilizce/erkek/mor.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/ingilizce/erkek/pembe.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/ingilizce/erkek/sari.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/ingilizce/erkek/turuncu.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/ingilizce/erkek/yesil.wav')

    pygame.mixer.music.load("renkler_dosyalar/sounds/turkce/kadin/yanlis.wav")
    pygame.mixer.music.load('renkler_dosyalar/sounds/turkce/kadin/dogru.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/turkce/kadin/kahverengi.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/turkce/kadin/kirmizi.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/turkce/kadin/mavi.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/turkce/kadin/mor.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/turkce/kadin/pembe.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/turkce/kadin/sari.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/turkce/kadin/turuncu.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/turkce/kadin/yesil.wav')

    pygame.mixer.music.load('renkler_dosyalar/sounds/turkce/erkek/yanlis.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/turkce/erkek/dogru.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/turkce/erkek/kahverengi.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/turkce/erkek/kirmizi.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/turkce/erkek/mavi.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/turkce/erkek/mor.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/turkce/erkek/pembe.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/turkce/erkek/sari.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/turkce/erkek/turuncu.wav')
    pygame.mixer.music.load('renkler_dosyalar/sounds/turkce/erkek/yesil.wav')

    sound_yanlis = pygame.mixer.Sound("renkler_dosyalar/sounds/" + str(sound_options_2[sound_options_int_2]) + str(sound_options[sound_options_int]) + "/yanlis.wav")
    sound_dogru = pygame.mixer.Sound("renkler_dosyalar/sounds/" + str(sound_options_2[sound_options_int_2]) + str(sound_options[sound_options_int]) + "/dogru.wav")
    ...
    while cap.isOpened():
        ...
        if not ret:
            continue
        true_img = cv2.imread("renkler_dosyalar/images/" + str(images[true_num]))
        false_img = cv2.imread("renkler_dosyalar/images/" + str(images[false_num]))
        ...
        if not paused:
            ...
            if not start_sound_bool:
                sound_true = pygame.mixer.Sound("renkler_dosyalar/sounds/" + str(sound_options_2[sound_options_int_2]) + str(sound_options[sound_options_int]) + "/" + str(sounds[true_num]))
                sound_true.play()
